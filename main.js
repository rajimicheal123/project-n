...
document.getElementById("staff-five-firstname").innerHTML =
  TableData.firstName[4];
document.getElementById("staff-six-firstname").innerHTML =
  TableData.firstName[5];
document.getElementById("staff-seven-firstname").innerHTML =
  TableData.firstName[6];
document.getElementById("staff-eight-firstname").innerHTML =
  TableData.firstName[7];
document.getElementById("staff-nine-firstname").innerHTML =
  TableData.firstName[8];
document.getElementById("staff-ten-firstname").innerHTML =
  TableData.firstName[9];
// lastName
document.getElementById("staff__one-lastname").innerHTML =
  TableData.lastName[0];
document.getElementById("staff__two-lastname").innerHTML =
  TableData.lastName[1];
document.getElementById("staff__three-lastname").innerHTML =
  TableData.lastName[2];
document.getElementById("staff-four-lastname").innerHTML =
  TableData.lastName[3];
document.getElementById("staff-five-lastname").innerHTML =
  TableData.lastName[4];
document.getElementById("staff-six-lastname").innerHTML = TableData.lastName[5];
document.getElementById("staff-seven-lastname").innerHTML =
  TableData.lastName[6];
document.getElementById("staff-eight-lastname").innerHTML =
  TableData.lastName[7];
document.getElementById("staff-nine-lastname").innerHTML =
  TableData.lastName[8];
...
//position
document.getElementById("staff__one-position").innerHTML =
  TableData.position[0];
document.getElementById("staff__two-position").innerHTML =
  TableData.position[1];
document.getElementById("staff__three-position").innerHTML =
  TableData.position[2];
document.getElementById("staff-four-position").innerHTML =
  TableData.position[3];
document.getElementById("staff-five-position").innerHTML =
  TableData.position[4];
document.getElementById("staff-six-position").innerHTML = TableData.position[5];
document.getElementById("staff-seven-position").innerHTML =
  TableData.position[6];
document.getElementById("staff-eight-position").innerHTML =
  TableData.position[7];
document.getElementById("staff-nine-position").innerHTML =
  TableData.position[8];
document.getElementById("staff-ten-position").innerHTML = TableData.position[9];

//date of employment
document.getElementById("staff__one-date").innerHTML =
  TableData.dateEmployed[0];
document.getElementById("staff__two-date").innerHTML =
  TableData.dateEmployed[1];
document.getElementById("staff__three-date").innerHTML =
  TableData.dateEmployed[2];
document.getElementById("staff-four-date").innerHTML =
  TableData.dateEmployed[3];
document.getElementById("staff-five-date").innerHTML =
  TableData.dateEmployed[4];
document.getElementById("staff-six-date").innerHTML = TableData.dateEmployed[5];
document.getElementById("staff-seven-date").innerHTML =
  TableData.dateEmployed[6];
document.getElementById("staff-eight-date").innerHTML =
  TableData.dateEmployed[7];
document.getElementById("staff-nine-date").innerHTML =
  TableData.dateEmployed[8];
